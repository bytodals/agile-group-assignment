  ...
  return (
    <div className="hp-root" data-sidebar-open="false">
        ...
        <nav className="hp-side-nav">
          <button className="hp-side-item"><Home className="icon" size={18} /> Home</button>
          <button className="hp-side-item"><Search className="icon" size={18} /> Search</button>
          <button className="hp-side-item" type="button" onClick={() => onNavigate('/saved-books')}><Bookmark className="icon" size={18} /> Shelf</button>
        </nav>
      </aside>
